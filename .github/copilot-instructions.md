...
*Last updated: 2025-06-22T01:54:38.793Z*
...
- **Functions**: 187
- **Interfaces**: 0
- **Last Indexed**: 2025-06-22T01:54:08.765Z
...
### Available Symbols
When suggesting code, you have instant access to 2164 symbols including:
- `metadata`\n- `files`\n- `classes`\n- `functions`\n- `todos`\n- `preferredModel`\n- `autoExecute`\n- `plugins`\n- `profiles`\n- `outputDirectories`\n- `preferredProvider`\n- `default`\n- `env`\n- `extends`\n- `rules`\n- `nodes`\n- `edges`\n- `stats`\n- `version`\n- `generated`
...
**🧠 AI Enhancement**: ✅ **2164 symbols** indexed for intelligent suggestions
